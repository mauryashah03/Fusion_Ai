...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Compare GPT, Llama 3, and Gemini instantly and receive the smartest combined answer. The premium multi-model AI workspace." },
      { name: "author", content: "Veriq AI" },
      { property: "og:title", content: "Veriq AI — Ask Once. Get Three Minds." },
      { property: "og:description", content: "Compare GPT, Llama 3, and Gemini instantly and receive the smartest combined answer." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Veriq AI" },
